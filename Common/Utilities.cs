...
namespace Common
{
    public static class Utilities
    {
        ...
        {
            string bPermissionCode = Utilities.DecimalToBinary(permissionCode);
            ...
            {
                permissions[k] = Utilities.BinaryToDecimal(permissions[k].ToString());
            }
        ...
        public static double DateTimeToUnixTimestamp(DateTime dateTime)
        {
            ...
            return Convert.ToDouble(unixTimeStampInTicks / TimeSpan.TicksPerSecond);
        }
